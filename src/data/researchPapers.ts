    ...
    papers: [
      ...
      },
      {
        ...
        intervention: {
          ...
          practice: "職場の関係の質は、人の身体に届いているように感じます。「よい関係」は気持ちの問題ではなく、身体の生理的状態に影響している——そのことを知ると、関係の大切さの意味が変わるように思います。",
        },
      },
      {
    ...
    papers: [
      {
        ...
        intervention: {
          ...
          practice: "場が安全かどうかは、理屈より先に、身体が判断しているように思います。その判断は意識より速く起きている——そのことを知ると、「安全な場を作る」の意味が変わります。",
        },
      },
      {
